...
const std::vector<ManagementPack>& builtin_management_packs() {
  static const std::vector<ManagementPack> packs{
      ...
      {"hyper-v-host", "0.2.15", AccessMode::management, {"windows-server-core"}, {"hyperv.host", "hyperv.virtual-machines", "hyperv.network", "hyperv.vm.lifecycle", "hyperv.vm.console"}},
