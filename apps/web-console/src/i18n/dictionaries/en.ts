export const en = {
  ...
  addSystem: {
    ...
    permissionRequired:
      "Agent or connector management permission is required to add a system",
  ...
  navigation: {
    ...
    agents: "Agents",
    soon: "Soon",
    version: "IPMS v0.2.13 development",
  },
  linuxSystems: {
  ...
  userAdministration: {
    ...
    liveData: "Live tenant-scoped identities and role assignments.",
    unavailableData: "User administration is currently unavailable.",
    eyebrow: "Administration · Identity and access",
    heading: "Users",
    description:
      "Manage local users and tenant roles through the same authorization boundary that future OIDC identities will use.",
    tableHeading: "Tenant users",
    search: "Search users",
    addUser: "Add user",
    username: "Username",
    ...
    oidc: "OIDC",
    hybrid: "Local + OIDC",
    edit: "Edit role and access",
    addHeading: "Add local user",
    editHeading: "Edit tenant access",
    initialPassword: "Initial password",
    passwordHint:
      "Use a unique password with at least 12 characters and deliver it through a separate secure channel.",
    ...
    actionFailed: "The user operation could not be completed.",
    usernameUnavailable: "This username is unavailable.",
    lastTenantAdmin: "At least one active tenant administrator must remain.",
    selfRoleChangeDenied:
      "You cannot remove your own tenant administrator access.",
    platformUserProtected:
      "Platform administrator assignments are managed at platform scope.",
    roles: {
