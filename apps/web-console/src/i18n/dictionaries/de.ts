...
export const de = {
  ...
  addSystem: {
    ...
    permissionRequired:
      "Zum Hinzufügen eines Systems sind Agent- oder Connector-Verwaltungsrechte erforderlich",
  ...
  navigation: {
    ...
    agents: "Agenten",
    soon: "Bald",
    version: "IPMS v0.2.20 Entwicklung",
  },
  linuxSystems: {
    liveData:
  ...
  userAdministration: {
    ...
    liveData: "Aktuelle mandantenbezogene Identitäten und Rollenzuweisungen.",
    unavailableData: "Die Benutzerverwaltung ist derzeit nicht verfügbar.",
    eyebrow: "Administration · Identitäten und Zugriff",
    heading: "Benutzer",
    description:
      "Lokale Benutzer und Mandantenrollen über dieselbe Berechtigungsgrenze verwalten, die später auch OIDC-Identitäten verwendet.",
    tableHeading: "Mandantenbenutzer",
    ...
    oidc: "OIDC",
    hybrid: "Lokal + OIDC",
    edit: "Rolle und Zugriff bearbeiten",
    addHeading: "Lokalen Benutzer hinzufügen",
    editHeading: "Mandantenzugriff bearbeiten",
    initialPassword: "Initiales Passwort",
    passwordHint:
      "Verwenden Sie ein eindeutiges Initialpasswort mit mindestens 12 Zeichen und übermitteln Sie es über einen separaten sicheren Kanal.",
    expirationOptional: "Ablaufzeit (optional)",
    noExpiration: "Kein Ablauf",
    create: "Benutzer erstellen",
    save: "Änderungen speichern",
    cancel: "Abbrechen",
    close: "Dialog schließen",
    noUsers: "Keine Benutzer entsprechen dem aktuellen Filter.",
    actionFailed: "Die Benutzeraktion konnte nicht abgeschlossen werden.",
    usernameUnavailable: "Dieser Benutzername ist nicht verfügbar.",
    lastTenantAdmin:
      "Mindestens ein aktiver Mandantenadministrator muss erhalten bleiben.",
    selfRoleChangeDenied:
      "Sie können Ihren eigenen Mandantenadministratorzugriff nicht entfernen.",
    platformUserProtected:
      "Plattformadministrator-Zuweisungen werden auf Plattformebene verwaltet.",
    roles: {
