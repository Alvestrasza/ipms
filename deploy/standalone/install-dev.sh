...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.7.zip"
AGENT_PACKAGE_SHA256="3a0f7910a79a256019ceec114c7c44ff1bbb15c43cc8f90f7fb820e748c6a791"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.7/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.7"
} >> "$control_plane_env"
