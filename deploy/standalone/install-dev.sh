...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.0.zip"
AGENT_PACKAGE_SHA256="b62eb1850542699641f6a224dd94816c9625f030e4b59747f112b1c01714d701"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.0/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.0"
} >> "$control_plane_env"
