...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.18.zip"
AGENT_PACKAGE_SHA256="c87f035d822bc4b478406ce8ca3522119c90421e8dc9ed9ab8b952a2ea214b89"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.23/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.18"
} >> "$control_plane_env"
