...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.19.zip"
AGENT_PACKAGE_SHA256="092167a37eafce8ecbc5f9ecfb7e8617eb225486f7670f93320a22312be6304c"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.24/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.19"
} >> "$control_plane_env"
