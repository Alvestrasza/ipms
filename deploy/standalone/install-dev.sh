...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.14.zip"
AGENT_PACKAGE_SHA256="35e715054ddf4fe36a66e4128fc9f34f5ae40855b188ab5f3aa72a98e790588d"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.19/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.14"
} >> "$control_plane_env"
