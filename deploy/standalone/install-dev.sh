...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.20.zip"
AGENT_PACKAGE_SHA256="db88840fdb2fed1eee35f165d762988e43247b372835de0f96698b0f1bfdb9ca"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.25/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.20"
} >> "$control_plane_env"
