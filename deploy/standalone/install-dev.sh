...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.15.zip"
AGENT_PACKAGE_SHA256="1a0b24aedebf7191d095f4473fc8f020acd33a04f3d826abff90f5e92df4d58c"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.20/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.15"
} >> "$control_plane_env"
