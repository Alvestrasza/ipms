...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.1.34.zip"
AGENT_PACKAGE_SHA256="276c3df25ac6a0fa1640ccd628fb2087887a1e948b9242bb90616403c4ab2715"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.1.49/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.1.34"
} >> "$control_plane_env"
