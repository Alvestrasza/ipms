...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.16.zip"
AGENT_PACKAGE_SHA256="a2725e141a92a3aeaac4a532e70d35d2b3d6f7e917f90b6eb26cb1ce46ef84ff"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.21/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.16"
} >> "$control_plane_env"
