...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.9.zip"
AGENT_PACKAGE_SHA256="d4743891d672dc67249fb70388251e51043c9035e55fd81aa9c9cfa4e7c5d770"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.9/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.9"
} >> "$control_plane_env"
