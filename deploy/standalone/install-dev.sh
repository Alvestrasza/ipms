...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.1.37.zip"
AGENT_PACKAGE_SHA256="65aed90f5e8069be74d37087450ba54574ce59347928151fe74519a8a6f613ee"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.1.52/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.1.37"
} >> "$control_plane_env"
