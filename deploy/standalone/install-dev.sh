...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.23.zip"
AGENT_PACKAGE_SHA256="10b44a4a0b8938c673b51bd3fa9560fee912991ff715897a9fabca8fcdfc58d3"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.28/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.23"
} >> "$control_plane_env"
