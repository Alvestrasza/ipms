...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.17.zip"
AGENT_PACKAGE_SHA256="9b930fe314a4f3835c7ebfc94e23fe2217dd359fd8e2e9fd46760546d931fedd"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.22/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.17"
} >> "$control_plane_env"
