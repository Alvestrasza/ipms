...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.1.zip"
AGENT_PACKAGE_SHA256="00cb383911a4172b8de41d8b95f15181abe26bddf07d85fdeea3f46095aad05b"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.1/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.1"
} >> "$control_plane_env"
