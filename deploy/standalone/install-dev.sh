...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.8.zip"
AGENT_PACKAGE_SHA256="15eedf49e02630164e0179b48effa1f90ad476a00182d88689aece327d5b272e"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.8/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.8"
} >> "$control_plane_env"
