...
AGENT_PACKAGE_NAME="ipms-agent-windows-x64-0.2.2.zip"
AGENT_PACKAGE_SHA256="964577d2a85944db22cf0e7950d5c340d46d9681fde74477cb9d96bcef305ed0"
AGENT_PACKAGE_URL="https://github.com/Alvestrasza/ipms/releases/download/v0.2.2/${AGENT_PACKAGE_NAME}"
    ...
    "$control_plane_env"
{
    ...
    echo "IPMS_AGENT_WINDOWS_VERSION=0.2.2"
} >> "$control_plane_env"
