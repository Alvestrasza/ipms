...
class TenantUserAdministrationApiTests(TestCase):
    ...
    def test_tenant_admin_creates_local_user_without_password_disclosure(self) -> None:
        ...
        self.assertNotIn("initial_password", body)
        self.assertNotIn("current_password", body)
        self.assertNotIn("new_password", body)
        self.assertNotIn("A-strong-test-only-password-729!", str(body))
        self.assertIsInstance(body["can_reset_password"], bool)
