...
anti-rollback policy, and MSI delivery remain mandatory before customer release.
...
the five compiled lifecycle actions defined by ADR-0008. Agent 0.2.14 adds only
