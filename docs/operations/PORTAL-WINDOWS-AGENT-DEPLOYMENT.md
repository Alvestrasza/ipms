...
IPMS 0.1.50 provides a development-grade portal bootstrap for Windows Agent
0.1.35. The workflow is tenant-scoped, audited, connection-approved, and
...
Agent 0.1.35 also uses well-known security identifiers inside the package. It
...
Until the first inventory succeeds, Agent 0.1.35 retries enrollment every ten
